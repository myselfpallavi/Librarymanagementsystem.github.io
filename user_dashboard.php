<?php
session_start();
function issuedbookcount()
{
    $connection= mysqli_connect("localhost","root","");
            $db=mysqli_select_db($connection,"lms");
            $issuebook="";
            $query="select count(*) as issuebook from issuedbook where Student_id=$_SESSION[Id]";
...
<body>
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <div class="card-body">
                <p class="card-text"> No. of Issued Book:
                    <?php echo issuedbookcount(); ?>
                </p>
            </div>
            <a href="viewissuedbook.php" class="btn btn-danger" target="_blank">View Issued Book</a>
            </div>
        </div> 
        </div>    
