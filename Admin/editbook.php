    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                    ...
                    <input type="text" name="Bookname" class="form-control" value="<?php echo $bookname?>" required>
                </div>
                <div class="form-group">
                    <label for="">Author id:</label>
                    <input type="text" name="Authorid" class="form-control"  value="<?php echo $authorid?>" required>
                </div>
                <div class="form-group">
                    <label for="">category id:</label>
                    <input type="text" name="Categoryid" class="form-control"  value="<?php echo $catid?>" required>
                </div>
                <div class="form-group">
                    <label for="">Book Number:</label>
                    <input type="text" name="Booknumber" class="form-control"  value="<?php echo $booknumber?>" required>
                </div>
                <div class="form-group">
                    <label for="">Book Price:</label>
                    <input type="text" name="Bookprice" class="form-control"  value="<?php echo $bookprice?>"required>
                </div><br>
                <button class="btn btn-primary" name="editbook" type="submit">Edit Book</button>
...
<?php
    if(isset($_POST['editbook']))
    {
        $connection= mysqli_connect("localhost","root","");
        $db=mysqli_select_db($connection,"lms");
        $query="UPDATE books Set Book_name='$_POST[Bookname]',Author_id=$_POST[Authorid]
            ,Cat_id=$_POST[Categoryid],Book_no=$_POST[Booknumber],Book_price=$_POST[Bookprice]
