            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="Admin/view_Profile.php">View Profile</a></li>
                        <li><a class="dropdown-item" href="Admin/edit_Profile.php">Edit Profile</a></li>
        ...
        <div class="col-md-4" >
                <form action="update.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input  class="form-control" name="Mobile_Number"  value="<?php echo $Mobile;?>">
                    </div>
                    <br>
