...
$Book_no="";
$Book_price="";
$query="select books.Book_id,books.Book_name,books.Book_no,books.Cat_id,books.Book_price,author.Author_Name from
        books left join author on books.Author_id=author.Author_Id";
?>
<!doctype html>
<html lang="en">
