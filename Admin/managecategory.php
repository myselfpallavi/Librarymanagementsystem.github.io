                    ...
                    <?php
                         ...
                         while($row=mysqli_fetch_assoc($query_run))
                         {
                            ...
                            <tr>
                                ...
                                <td><button class="btn" name=""><a href="editcategory.php?nm=<?php echo $row['Cat_id'];?>">Edit</a></button>
                                <button class="btn" name=""><a href="deletecategory.php?nm=<?php echo $row['Cat_id'];?>">Delete</a></button>
                                </td>
                         </tr>
                            <?php
                         }
