    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                ...
                <br>
                <button class="btn btn-primary" type="submit" name="issuebook">Issue Book</button>
            </form>
        </div>
...
<?php
  if(isset($_POST['issuebook']))
  {
    $connection= mysqli_connect("localhost","root","");
    $db=mysqli_select_db($connection,"lms");
    $query="insert into issuedbook values (null,$_POST[booknumber],'$_POST[bookname]',
    '$_POST[bookauthor]',$_POST[studentid],1,'$_POST[issuedate]')";
    $query_run=mysqli_query($connection,$query);
  }
?>
</html>