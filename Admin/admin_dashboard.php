      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu">
            ...
            <li><a class="dropdown-item" href="msnagecategory.php">Manage Category</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          <button class="btn dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <div class="row row-cols-1 row-cols-md-4 g-4">
        <div class="col">
            ...
            <div class="card-header">Registered User</div>
                <p class="card-text"> No. of Registered User:<?php echo get_user_count();?></p>
            </div>
            <a href="Register.php" class="btn btn-danger" target="_blank">View Registered User</a>
            </div>
        </div>
        <div class="col">
            <div class="card h-100">
            ...
            <div class="card-header">Registered Books</div>
                <p class="card-text">No. of Registered Book:<?php echo get_book_count();?> </p>
            </div>
        ...
        <div class="col">
            <div class="card h-100">
            <div class="card-body">
            <div class="card-header">Regestered Categories</div>
                <p class="card-text">No. of Book Category:<?php echo get_cat_count();?> </p>
            </div>
        ...
        <div class="col">
            ...
            <a href="regauthor.php" target="_blank" class="btn btn-primary">View Author</a>
            </div>
        </div>
        <div class="col">
            <div class="card h-100">
            ...
            <div class="card-header">Issued Book</div>
                <p class="card-text"> No. of Issued Book:<?php echo get_issuedbook_count();?></p>
            </div>
