...
$query="select * from author where Author_id=$_GET[nm] ";
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                    ...
                    <input type="text" name="Authorname" class="form-control" value="<?php echo $authorname?>" required>
                </div>
                <br>
                <button class="btn btn-primary" name="edit" type="submit">Edit Auhtor</button>
...
<?php
    if(isset($_POST['edit']))
    {
        $connection= mysqli_connect("localhost","root","");
        $db=mysqli_select_db($connection,"lms");
        $query="UPDATE author Set Author_Name='$_POST[Authorname]'
             WHERE Author_Id = $_GET[nm] ";
        $query_run=mysqli_query($connection,$query);
