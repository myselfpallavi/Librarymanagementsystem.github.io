...
$query="select * from categories where Cat_id=$_GET[nm] ";
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                    ...
                    <input type="text" name="Categoryname" class="form-control" value="<?php echo $catname?>" required>
                </div>
                <br>
                <button class="btn btn-primary" name="editcategory" type="submit">Edit Category</button>
...
<?php
    if(isset($_POST['editcategory']))
    {
        $connection= mysqli_connect("localhost","root","");
        $db=mysqli_select_db($connection,"lms");
        $query="UPDATE categories Set Cat_Name='$_POST[Categoryname]'
             WHERE Cat_id = $_GET[nm] ";
        $query_run=mysqli_query($connection,$query);
