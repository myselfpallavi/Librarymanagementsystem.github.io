                    ...
                    <?php
                         ...
                         while($row=mysqli_fetch_assoc($query_run))
                         {
                            ...
                            <tr>
                                ...
                                <td><button class="btn" name=""><a href="editauthor.php?nm=<?php echo $id?>">Edit</a></button>
                                <button class="btn" name=""><a href="deleteauthor.php?nm=<?php echo $id?>">Delete</a></button>
                                </td>
                         </tr>
                            <?php
                         }
